...
class TestFinancialReport(TestAccountReportsCommon):
    ...
    def setUpClass(cls):
        ...
        cls.report = cls.env.ref('at_accounting.balance_sheet')
    ...
    def test_financial_report_single_company(self):
        line_id = self._get_basic_line_dict_id_from_report_line_ref('at_accounting.account_financial_report_bank_view0')
        self.report.filter_multi_company = 'disabled'
    ...
    def test_financial_report_horizontal_group(self):
        line_id = self._get_basic_line_dict_id_from_report_line_ref('at_accounting.account_financial_report_receivable0')
    ...
    def test_option_hierarchy(self):
        ...
        move.action_post()
        move.line_ids.flush_recordset()
        profit_and_loss_report = self.env.ref('at_accounting.profit_and_loss')
        line_id = self._get_basic_line_dict_id_from_report_line_ref('at_accounting.account_financial_report_revenue0')
