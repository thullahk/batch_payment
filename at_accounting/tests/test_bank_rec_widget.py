# -*- coding: utf-8 -*-
from odoo.addons.at_accounting.tests.test_bank_rec_widget_common import TestBankRecWidgetCommon
...
class TestBankRecWidget(TestBankRecWidgetCommon):
    ...
    def test_auto_reconcile_cron(self):
        ...
        cron = self.env.ref('at_accounting.auto_reconcile_bank_statement_line')
