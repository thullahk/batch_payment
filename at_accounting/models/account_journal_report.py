...
class JournalReportCustomHandler(models.AbstractModel):
    ...
    def _get_custom_display_config(self):
        return {
            ...
            'components': {
                'AccountReportLine': 'at_accounting.JournalReportLine',
            },
            'templates': {
                'AccountReportFilters': 'at_accounting.JournalReportFilters',
                'AccountReportLineName': 'at_accounting.JournalReportLineName',
            }
        }
    ...
    def export_to_pdf(self, options):
        ...
        body = self.env['ir.qweb']._render('at_accounting.journal_report_pdf_export_main', render_values)
    ...
    def _query_bank_journal_initial_balance(self, options, journal_id):
        report = self.env.ref('at_accounting.journal_report')
    ...
    def journal_report_open_aml_by_move(self, options, params):
        ...
        if journal.type in ('bank', 'credit'):
            params['view_ref'] = 'at_accounting.view_journal_report_audit_bank_move_line_tree'
            context_update['search_default_exclude_bank_lines'] = 1
        else:
            params['view_ref'] = 'at_accounting.view_journal_report_audit_move_line_tree'
