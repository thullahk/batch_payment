    ...
    def _customize_warnings(self, report, options, all_column_groups_expression_totals, warnings):
        ...
        if warnings is not None:
            if last_statement and general_ledger_not_matching:
                warnings['at_accounting.journal_balance'] = {
                    'alert_type': 'warning',
            ...
            if inconsistent_statement:
                warnings['at_accounting.inconsistent_statement_warning'] = {'alert_type': 'warning', 'args': inconsistent_statement}
            if has_bank_miscellaneous_move_lines:
                warnings['at_accounting.has_bank_miscellaneous_move_lines'] = {'alert_type': 'warning', 'args': journal.default_account_id.display_name}

    def _compute_journal_balances(self, report, options, journal, journal_currency):
        """
            This function compute all necessary information for the warning 'at_accounting.journal_balance'
