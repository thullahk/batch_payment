...
import { AccountReportAnnotationsPopover } from "@at_accounting/components/account_report/line_name/popover/annotations_popover";

export class AccountReportLineName extends Component {
    static template = "at_accounting.AccountReportLineName";
    static props = {
        lineIndex: Number,
        line: Object,
    };
