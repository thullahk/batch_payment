...
import { AnnotationPopoverLine } from "@at_accounting/components/account_report/line_name/popover_line/annotation_popover_line";

const { DateTime } = luxon;

export class AccountReportAnnotationsPopover extends Component {
    static template = "at_accounting.AccountReportAnnotationsPopover";
    static props = {
        controller: Object,
        lineName: Object,
        lineID: String,
