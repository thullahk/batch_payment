...
import { AccountReportCarryoverPopover } from "@at_accounting/components/account_report/line_cell/popover/carryover_popover";
import { AccountReportEditPopover } from "@at_accounting/components/account_report/line_cell/popover/edit_popover";

import { Component, markup, useState } from "@odoo/owl";

export class AccountReportLineCell extends Component {
    static template = "at_accounting.AccountReportLineCell";
    static props = {
        line: {
            type: Object,
            optional: true,
