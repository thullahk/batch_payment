...
import { AccountReportEllipsisPopover } from "@at_accounting/components/account_report/ellipsis/popover/ellipsis_popover";

export class AccountReportEllipsis extends Component {
    static template = "at_accounting.AccountReportEllipsis";
    static props = {
