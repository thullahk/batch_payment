...
import { AccountReportController } from "@at_accounting/components/account_report/controller";
import { AccountReportButtonsBar } from "@at_accounting/components/account_report/buttons_bar/buttons_bar";
import { AccountReportCogMenu } from "@at_accounting/components/account_report/cog_menu/cog_menu";
import { AccountReportEllipsis } from "@at_accounting/components/account_report/ellipsis/ellipsis";
import { AccountReportFilters } from "@at_accounting/components/account_report/filters/filters";
import { AccountReportHeader } from "@at_accounting/components/account_report/header/header";
import { AccountReportLine } from "@at_accounting/components/account_report/line/line";
import { AccountReportLineCell } from "@at_accounting/components/account_report/line_cell/line_cell";
import { AccountReportLineName } from "@at_accounting/components/account_report/line_name/line_name";
import { AccountReportSearchBar } from "@at_accounting/components/account_report/search_bar/search_bar";
import { standardActionServiceProps } from "@web/webclient/actions/action_service";
import { useSetupAction } from "@web/search/action_hook";


export class AccountReport extends Component {
    static template = "at_accounting.AccountReport";
    ...
    getTemplate(name) {
        ...
        return `at_accounting.${ name }Customizable`;
    }
