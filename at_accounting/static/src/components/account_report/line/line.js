...
import { AccountReportDebugPopover } from "@at_accounting/components/account_report/line/popover/debug_popover";
import { AccountReportLineCellEditable } from "@at_accounting/components/account_report/line_cell_editable/line_cell_editable";

export class AccountReportLine extends Component {
    static template = "at_accounting.AccountReportLine";
    static props = {
        lineIndex: Number,
        line: Object,
    };
