...
class AccountBatchPayment(models.Model):
    ...
    def print_batch_payment(self):
        return self.env.ref('at_accounting_batch_payment.action_print_batch_payment').report_action(self, config=False)
    ...
    def action_open_batch_payment(self):
        ...
        return {
            ...
            'type': 'ir.actions.act_window',
            'view_mode': 'form',
            'view_id': self.env.ref('at_accounting_batch_payment.view_batch_payment_form').id,
